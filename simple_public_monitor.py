...
# -*- coding: utf-8 -*-
"""
Simple Screenshot Monitor for PUBLIC Repository
- GitHub Issueタイトル変更時のみスクリーンショット撮影・投稿
- Claude Codeへの送信なし（GitHub Issue内のみで完結）
- PUBLIC REPOSITORY: Tenormusica2024/web-remote-desktop
"""
...
# ---------- Config - PUBLIC Repository ----------
ROOT = Path(__file__).resolve().parent
load_dotenv(ROOT / ".env", override=True)  # PUBLIC用設定

GITHUB_TOKEN = os.getenv("GITHUB_TOKEN")
GITHUB_REPO = "Tenormusica2024/web-remote-desktop"  # PUBLIC Repository
GITHUB_BRANCH = "master"
MONITOR_ISSUE = "1"
POLL_INTERVAL = 30  # 秒

API_BASE = "https://api.github.com"
LAST_TITLE_FILE = ROOT / "last_title_public.txt"
LOG_FILE = ROOT / "public_monitor.log"
