...
if ($process) {
    ...
    Write-Host "   Status: .\Start-BackgroundMonitor-simple.ps1 -ShowStatus" -ForegroundColor Gray
    Write-Host "   Logs: .\Start-BackgroundMonitor-simple.ps1 -Logs" -ForegroundColor Gray
    Write-Host "   Stop: .\Start-BackgroundMonitor-simple.ps1 -Stop" -ForegroundColor Gray
} else {
